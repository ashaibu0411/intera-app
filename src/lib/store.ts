...
export const STATES_BY_COUNTRY: Record<string, string[]> = {
  ...
  GH: ['Greater Accra', 'Ashanti', 'Western Region', 'Eastern Region', 'Central Region', 'Northern Region', 'Volta Region'],
...
export const CITIES_BY_STATE: Record<string, string[]> = {
  ...
  'Greater Accra': ['Accra', 'Tema', 'Madina', 'Teshie', 'Nungua', 'Kasoa', 'Ashaiman'],
  'Ashanti': ['Kumasi', 'Obuasi', 'Ejisu', 'Konongo', 'Mampong', 'Bekwai', 'Agogo'],
  'Western Region': ['Takoradi', 'Sekondi', 'Tarkwa', 'Axim', 'Elubo', 'Half Assini'],
  'Eastern Region': ['Koforidua', 'Nkawkaw', 'Akim Oda', 'Akosombo', 'Suhum', 'Nsawam'],
  'Central Region': ['Cape Coast', 'Winneba', 'Elmina', 'Mankessim', 'Agona Swedru', 'Kasoa'],
  'Northern Region': ['Tamale', 'Yendi', 'Damongo', 'Savelugu', 'Bimbilla', 'Salaga'],
  'Volta Region': ['Ho', 'Sogakope', 'Keta', 'Aflao', 'Hohoe', 'Kpando', 'Denu'],
...
export const MOCK_POSTS: Post[] = [
  // Local conversations - matching IDs in ActiveConversations
  {
    id: '1',
    author: {
      id: 'amara1',
      ...
      bio: 'Food lover and community connector',
      location: 'Denver, CO',
      interests: ['Food', 'Culture'],
      joinedDate: '2024-01-15',
    },
    content: 'Does anyone know a good Nigerian restaurant near downtown? Looking for authentic jollof rice and suya. My family is visiting next week and I want to show them the best African food in the city!',
    images: [],
    likes: 8,
    comments: 8,
  ...
  },
  {
    ...
    author: {
      ...
      bio: 'New Arrival from Accra',
      location: 'Denver, CO',
      interests: ['Housing', 'Community'],
      joinedDate: '2024-12-20',
    },
    content: 'New here, looking for roommates in the downtown area. Just moved from Ghana last week and trying to find affordable housing. Preferably other African professionals. Budget around $800-1000/month. Clean, quiet, and respectful. Please DM if you know of anything!',
    images: [],
    likes: 12,
    comments: 12,
  ...
  },
  {
    ...
    author: {
      ...
      bio: 'Navigating life in America',
      location: 'Denver, CO',
      interests: ['Immigration', 'Community'],
      joinedDate: '2024-06-15',
    },
    content: 'Anyone else experiencing issues with the DMV appointments? I have been trying to book for 3 weeks now and every slot is taken. Need to renew my license urgently. Any tips or alternative locations that have shorter waits?',
    images: [],
    likes: 23,
    comments: 23,
  ...
  },
  {
    ...
    author: {
      ...
      location: 'Denver, CO',
      interests: ['Outdoors', 'Fitness', 'Community'],
      joinedDate: '2024-03-10',
    },
    content: 'Who wants to join for a weekend hike? Planning to hit up Red Rocks this Saturday morning around 8am. Great way to meet fellow Africans who love the outdoors! Moderate difficulty, about 3 miles. Bring water and snacks. Drop a comment if interested!',
  ...
  // Global conversations - matching IDs in ActiveConversations
  {
    id: 'g1',
    author: {
      id: 'yemi1',
      ...
      bio: 'Tech professional exploring Europe',
      location: 'Berlin, Germany',
      interests: ['Tech', 'Career', 'Travel'],
      joinedDate: '2024-02-01',
    },
    content: 'Best cities for African tech professionals in Europe? I am considering relocating from Nigeria and want to know where the best opportunities and African communities are. Berlin has been great but curious about London, Amsterdam, Dublin. What has been your experience?',
    images: [],
    likes: 47,
    comments: 47,
  ...
  },
  {
    ...
    author: {
      ...
      bio: 'Mother of two, preserving our heritage',
      location: 'Toronto, Canada',
      interests: ['Family', 'Culture', 'Language'],
      joinedDate: '2024-01-20',
    },
    content: 'How are you maintaining your native language with kids abroad? My children (5 and 8) are starting to prefer English over Yoruba at home. Looking for tips from other parents on how to keep our language alive. Do you have tutors, weekend schools, or other methods that work?',
    images: [],
    likes: 89,
    comments: 89,
  ...
  },
  {
    ...
    author: {
      ...
      bio: 'Missing home-cooked food',
      location: 'New York, USA',
      interests: ['Food', 'Cooking', 'Culture'],
      joinedDate: '2024-04-15',
    },
    content: 'Looking for African grocery suppliers that ship internationally. I need authentic palm oil, stockfish, and groundnut paste. The local stores here are limited and overpriced. Anyone know reliable online suppliers that ship to the US?',
    images: [],
    likes: 34,
    comments: 34,
  ...
  },
  {
    ...
    author: {
      ...
      bio: 'Immigration Lawyer helping our community',
      location: 'London, UK',
      interests: ['Law', 'Immigration', 'Community'],
      joinedDate: '2024-01-01',
    },
    content: 'Free immigration consultation for first-gen immigrants. As someone who went through the process myself, I want to give back. Offering 30-minute free consultations for visa questions, work permits, and residency applications. DM me to book a slot. Let us help each other navigate the system!',
    images: [],
    likes: 156,
    comments: 156,
